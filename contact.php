...
<body>
    ...
    <?php include 'header.php';?>
        ...
        <section class="page-header">
            <div class="page-header-bg" style="background-image: url(assets/images/contact-header.jpg)"></div>
              <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="contact-info__single">
                            ...
                            <p class="contact-info__text">Pranav Heavy Industries Private Limited, Gat No 285 / 2, 
                                Near Steel India Company, 
                                Nanekar wadi Chakan, – Khed, 
                                Dist. – Pune. – 410 501</p>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="contact-info__single">
                            <h4 class="contact-info__title">Have any quetion?</h4>
                            <p class="contact-info__text"> 
                                <a href="tel:919766086375">+91 9766086375</a></p>
                                <p class="contact-info__text">
                                    <a href="tel:918983730051">+91 8983730051</a></p>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="contact-info__single">
                            <h4 class="contact-info__title">Write Email</h4>
                            <p class="contact-info__text">
                                <a href="patilabhijeet@pranavindustries.co.in">patilabhijeet@pranavindustries.co.in</a></p>
                            <div class="contact-info__btn-box">
                                <div class="contact-info__btn">
                                    <a href="contact.php">Contact</a>
                                </div>
                    ...
                    <h2 class="section-title__title">Feel free to write our <br> team anytime</h2>
                	 ...
                	 <?php
                                       ...
                                       //    $to = "pratikshabirdawade1996@gmail.com"; // this is your Email address
                                         $to = "patilabhijeet@pranavindustries.co.in"; // this is your Email address
                                           $subject = 'Enquiry From Website';
                                        
                                           $headers = "From: Contact Pranav Heavy Industries Private Limited <noreply@pranavindustries.co.in>\r\n";
                                           $headers .= "Reply-To: noreply@pranavindustries.co.in\r\n";
                                           $headers .= "MIME-Version: 1.0\r\n";
                                           $headers .= "Content-Type: text/html; charset=UTF-8\r\n";
                                           $returnpath = '-f noreply@pranavindustries.co.in';
                                        
                                           $message = 'Hello Sir <Br> You have received new Contact Enquiry From Pranav Heavy Industries Private Limited Website ';
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="contact-page-form__btn-box">
                                <button type="submit" class="thm-btn contact-page-form__btn" name="enquiry-submit">Send a message</button>
                            </div>
                        </div>
                    </div>
                </form>
